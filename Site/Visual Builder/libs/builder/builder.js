...
Vvveb.Builder = {
	...
	_frameLoaded: function () {
		...
		self.frameHead.append(generateElements('<link data-vvveb-helpers href="' + Vvveb.baseUrl + '../../css/CodeArt-editor-helpers.css" rel="stylesheet">')[0]);
...
Vvveb.Gui = {
	...
	darkMode: function () {
		...
		if (theme == "dark") {
			...
			if (logo) logo.src = "img/logo-white.png";
		} else {
			theme = "auto";
		}
