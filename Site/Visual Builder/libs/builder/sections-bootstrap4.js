...
Vvveb.Sections.add("bootstrap4/signin-split", {
  ...
  image: "https://i.ibb.co/9qFbbS2/team-6-thumb.png",
  html: `
<section>
  <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-md-9 col-lg-8 mx-auto">
                ...
                <form>
                  ...
                  <!-- Sign In Button -->
                  <button class="btn btn-lg btn-primary btn-login text-uppercase font-weight-bold mb-2" type="submit">Sign in</button>
    ...
    <style>
      ...
      .bg-image {
        background-image: url('https://i.pinimg.com/736x/cd/23/35/cd2335bcc44ec7fd8cd1facef957070a.jpg');
...
Vvveb.Sections.add("bootstrap4/image-gallery", {
  name: "Image gallery",
  image: "https://i.ibb.co/S5Sn1Q3/Gallery.png",
  dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',
  html: `
  ...
  <div class="row text-center text-lg-left">
    ...
    <div class="col-lg-3 col-md-4 col-6">
      <a href="#" class="d-block mb-4 h-100">
            <img class="img-fluid img-thumbnail" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWn5u3xNHr6mViwgZOGUkc1TRlKB77tLkiTw&s" alt="">
          </a>
    </div>
    <div class="col-lg-3 col-md-4 col-6">
      <a href="#" class="d-block mb-4 h-100">
            <img class="img-fluid img-thumbnail" src="https://cdn.dribbble.com/users/823181/screenshots/3894893/scenery_illustration.png?resize=400x300&vertical=center" alt="">
          </a>
    </div>
    <div class="col-lg-3 col-md-4 col-6">
      <a href="#" class="d-block mb-4 h-100">
            <img class="img-fluid img-thumbnail" src="https://cdn.dribbble.com/userupload/17818660/file/original-89016b7f09707354c674e55665947878.png?format=webp&resize=400x300&vertical=center" alt="">
          </a>
    </div>
    <div class="col-lg-3 col-md-4 col-6">
      <a href="#" class="d-block mb-4 h-100">
            <img class="img-fluid img-thumbnail" src="https://cdn.dribbble.com/users/823181/screenshots/3884775/scenery_illustration.png?resize=400x300&vertical=center" alt="">
          </a>
    </div>
    <div class="col-lg-3 col-md-4 col-6">
      <a href="#" class="d-block mb-4 h-100">
...
Vvveb.Sections.add("bootstrap4/slider-header", {
  ...
  dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',
  image: "https://i.ibb.co/rsGSV3H/image.png",
  html: `
<header class="slider" data-name="slider">
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="carousel-item active" style="background-image: url('https://wallpapers.com/images/hd/1920x1080-aesthetic-glrfk0ntspz3tvxg.jpg')">
      ...
      <div class="carousel-item" style="background-image: url('https://wallpapers.com/images/featured/ultra-hd-wazf67lzyh5q7k32.jpg')">
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item" style="background-image: url('https://images.wallpapersden.com/image/download/panorama-vector-city_bGpqbWyUmZqaraWkpJRmbmdlrWZlbWU.jpg')">
        <div class="carousel-caption d-none d-md-block">
...
Vvveb.Sections.add("bootstrap4/about-team", {
  ...
  dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/image.svg">',
  image: "https://i.ibb.co/ZXcY7F3/Team.png",
  html: `
  ...
  <div class="row">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-0 shadow">
        <img src="https://i.ibb.co/9rX7HjM/1.jpg" class="card-img-top" alt="...">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-0 shadow">
        <img src="https://i.ibb.co/g3zz3tL/2.jpg" class="card-img-top" alt="...">
        <div class="card-body text-center">
          <h5 class="card-title mb-0">Team Member</h5>
          <div class="card-text text-black-50">Web Developer</div>
        </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-0 shadow">
        <img src="https://i.ibb.co/xDWWFZP/3.jpg" class="card-img-top" alt="...">
        <div class="card-body text-center">
          <h5 class="card-title mb-0">Team Member</h5>
          <div class="card-text text-black-50">Web Developer</div>
        </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-0 shadow">
        <img src="https://i.ibb.co/RcYPXb2/4.jpg" class="card-img-top" alt="...">
        <div class="card-body text-center">
          <h5 class="card-title mb-0">Team Member</h5>
          <div class="card-text text-black-50">Web Developer</div>
        </div>
