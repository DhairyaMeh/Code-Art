Vvveb.Sections.add("hero/hero-1", {
 ...
 <div class="frame mx-auto">
      <video loading="lazy" src="/screenshots/sections/video/codeart.mp4" muted="" loop="" controls="" poster="/screenshots/sections/video/codeart.png"></video>
    </div>
  </div>
    ...
    <!--
		<div class="row justify-content-end">
			<div class="col-md-3 text-muted text-small mt-5">
				&copy; <span data-v-year>2023</span> <span data-v-sitename>Vvveb</span>. Powered by <a href="cdrt" target="_blank">Vvveb</a>	
			</div>
		</div>
		-->
    ...
    <div class="container">
      <div class="d-flex flex-column flex-md-row">
        ...
        <div class="text-muted">
          ...
          <a href="cdrt" class="btn-link text-muted" target="_blank">Vvveb</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="d-flex">
        ...
        <div class="text-muted text-small">
          &copy; <span data-v-year>2023</span>
          <span data-v-sitename>Vvveb</span>. Powered by <a href="cdrt" class="btn-link text-muted" target="_blank">Vvveb</a>
        </div>
      </div>
    </div>
  </div>
