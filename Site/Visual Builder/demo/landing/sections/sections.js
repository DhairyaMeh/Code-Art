Vvveb.Sections.add("hero/hero-1", {
    ...
    <div class="heading">
      ...
      <div class="btns">
        ...
        <div class="nav-item dropdown">
          <a class="btn btn-outline-primary nav-link dropdown-toggle" href="add your url" role="button">Live demo <b>›</b>
          </a>
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            <a class="dropdown-item" target="_blank" href="add your url/admin/?module=/editor/editor&template=index.html&url=/">Page builder</a>
            <a class="dropdown-item" target="_blank" href="add your url">Frontend</a>
            <a class="dropdown-item" target="_blank" href="add your url/admin">Admin dashboard</a>
          </div>
        </div>
      </div>
 ...
 <div class="frame mx-auto">
      <video loading="lazy" src="/screenshots/sections/video/codeart.mp4" muted="" loop="" controls="" poster="https://i.ibb.co/L81NykH/codeart.png"></video>
    </div>
  </div>
      ...
      <div class="row align-items-center justify-content-center text-center">
        <div class="col-lg-12">
          ...
          <div class="buttons" data-aos="fade-up" data-aos-delay="300">
            ...
            <a href="" class="btn btn-white">Live Demo</a>
          </div>
    ...
    <div class="row align-items-center justify-content-center text-center">
      <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="buttons">
          ...
          <a href="" class="btn btn-white btn-lg">Live Demo</a>
              ...
              <div class="row align-items-center justify-content-center text-start">
                <div class="col-lg-7">
                  ...
                  <div class="buttons mt-4" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <a href="" class="btn btn-white text-white btn-lg">Live Demo</a>
                  </div>
...
Vvveb.Sections.add("contact-form/contact-form-1", {
  ...
  <div class="container-fluid p-0 pb-5">
    <iframe loading="lazy" class="map" title="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d118106.70010221681!2d73.17308625!3d22.32210265!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395fc8ab91a3ddab%3A0xac39d3bfe1473fb8!2sVadodara%2C%20Gujarat!5e0!3m2!1sen!2sin!4v1735801500377!5m2!1sen!2sin" style="border:0" allowfullscreen="" width="100%" height="300" frameborder="0"></iframe>
  </div>
  <div class="container">
    <div class="row pt-5">
      <div class="col-12">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-12 col-md-8 col-lg pt-5 m-auto pt-lg-0">
        <iframe loading="lazy" class="mb-4" title="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d118106.70010221681!2d73.17308625!3d22.32210265!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395fc8ab91a3ddab%3A0xac39d3bfe1473fb8!2sVadodara%2C%20Gujarat!5e0!3m2!1sen!2sin!4v1735801500377!5m2!1sen!2sin" style="border:0" allowfullscreen="" width="100%" height="200" frameborder="0"></iframe>
  ...
  <div class="">
    <div class="container">
      ...
      <div class="row justify-content-center text-center">
        ...
        <div class="col-12 col-md pt-4 me-auto ms-auto">
          <p class="lead">support@CodeArt.com</p>
        </div>
      </div>
      <div class="row-50"></div>
    </div>
  ...
  <div class="container" data-v-component-menu="footer" data-v-slug="main-footer">
    ...
    <div class="row" data-v-menu-items>
      ...
      <div class="col-md" data-v-menu-item data-v-if="category.children > 0">
        <div class="h6" data-v-menu-item-name>CodeArt</div>
    ...
    <!--
		<div class="row justify-content-end">
			<div class="col-md-3 text-muted text-small mt-5">
				&copy; <span data-v-year>2023</span> <span data-v-sitename>CodeArt</span>. Powered by <a href="cdrt" target="_blank">CodeArt</a>	
			</div>
		</div>
		-->
    ...
    <div class="container">
      <div class="d-flex flex-column flex-md-row">
        ...
        <div class="text-muted">
          ...
          <span data-v-global-site.description.title>CodeArt</span>. <span>Powered by</span>
          <a href="cdrt" class="btn-link text-muted" target="_blank">CodeArt</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container" data-v-component-menu="footer" data-v-slug="main-menu">
    ...
    <div class="row" data-v-menu-items>
      ...
      <div class="col-md">
        ...
        <div data-v-component-site>
          <img src="img/logo-white.png" alt="Site logo dark" class="logo-default" loading="lazy" class="logo-default-dark" data-v-site-logo-dark>
        </div>
    ...
    <div class="container">
      <div class="d-flex">
        ...
        <div class="text-muted text-small">
          &copy; <span data-v-year>2023</span>
          <span data-v-sitename>CodeArt</span>. Powered by <a href="cdrt" class="btn-link text-muted" target="_blank">CodeArt</a>
        </div>
      </div>
    </div>
  </div>
        ...
        <ul class="navbar-nav ms-auto" data-v-menu-items>
          <li class="nav-item dropdown position-static" data-v-menu-item data-v-class-if-has-dropdown="category.children > 0" data-v-class-if-position-static="category.has-text">
            ...
            <div class="dropdown-menu" data-v-menu-item-recursive>
              ...
              <div data-v-menu-item class="nav-item" data-v-class-if-dropdown="category.children > 0">
                <a class="dropdown-item" href="" data-v-class-if-active="category.active" data-v-menu-item-url>
          ...
          <li class="nav-item dropdown" data-v-menu-item>
            <a class="nav-link dropdown-toggle" href="#" data-v-menu-item-url>
              <span data-v-menu-item-name>Blog</span>
            </a>

            <div class="dropdown-menu" data-v-menu-item-recursive>
              <div data-v-menu-item class="nav-item" data-v-class-if-dropdown="category.children > 0">
                <a class="dropdown-item" href="" data-v-menu-item-url>
          ...
          <li class="nav-item" data-v-menu-item>
            <a class="nav-link" href="/page/contact" data-v-menu-item-url>
              <span data-v-menu-item-name>Contact</span>
            </a>
          </li>
          <li class="nav-item" data-v-menu-item>
            <a class="nav-link" href="" data-v-menu-item-url>
			  ...
			  <div class="collapse navbar-collapse" id="navbar">
				<ul class="navbar-nav ms-auto">
				  ...
				  <li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="dropdown01">
					  <a class="dropdown-item" target="_blank"  href="">User Documentation</a>
					  <a class="dropdown-item" target="_blank"  href="">Developer Documentation</a>
					</div>
				  </li>
				  <li class="nav-item">
				  ...
				  <li class="nav-item active">
					<a class="nav-link" href="cdrt/download.php">Download for free</a>
				  </li>			  
				</ul>
			  </div>
			  -->
    ...
    <div class="row g-1 justify-content-center">
      <div class="col-12 col-sm-6 col-md-6 col-lg-3">
        <div class="feature" data-aos="fade-up" data-aos-delay="100">
          ...
          <p class="text-center">CodeArt is 100% safe against sql injections, a vulerability that affects most CMS.</p>
        </div>
      </div>
      <div class="col-12 col-sm-6 col-md-6 col-lg-3">
        <div class="feature" data-aos="fade-up" data-aos-delay="200">
          ...
          <p class="text-center">CodeArt uses only html for templating for maximum flexibility.</p>
        </div>
      </div>
      <div class="col-12 col-sm-6 col-md-6 col-lg-3">
        <div class="feature" data-aos="fade-up" data-aos-delay="300">
          ...
          <p class="text-center">CodeArt is a full featured ecommerce platform with advanced functionality.</p>
        </div>
      </div>
      <div class="col-12 col-sm-6 col-md-6 col-lg-3">
    ...
    <div class="row g-1 justify-content-center">
      <div class="col-12 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="0">
        <div class="feature">
          ...
          <p>CodeArt is 100% safe against sql injections, a vulerability that affects most CMS.</p>
      ...
      <div class="col-12 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
        <div class="feature">
          ...
          <p>CodeArt uses only html for templating for maximum flexibility.</p>
          <a class="more d-block" href="#">
            Read more
            <i class="font-icon la la-chevron-circle-right"></i>
          </a>
      ...
      <div class="col-12 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="200">
        <div class="feature">
          ...
          <p>CodeArt is a full featured ecommerce platform with advanced functionality.</p>
          <a class="more d-block" href="#">
            Read more
            <i class="font-icon la la-chevron-circle-right"></i>
          </a>
      ...
      <div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="600">
        <div class="feature">
          ...
          <div class="text">
            ...
            <p>CodeArt is a full featured ecommerce platform with advanced functionality and internationalization.</p>
            <a class="more d-block" href="#">
              Read more
              <i class="font-icon la la-chevron-circle-right"></i>
            </a>
